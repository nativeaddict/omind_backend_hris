...
Route::prefix('data-tables')->group(function () {
  ...
  Route::get('/project', 'Admins\AdminProjectController@listProject')->name('project');
  Route::get('/employee-project', 'Admins\AdminKaryawanProjectController@listProjectKaryawan')->name('employee-project');
...
Route::prefix('blog')->group(function () {
  Route::get('/news', 'Admins\AdminNewsController@viewNews')->name('news');
  Route::view('/blog-single', 'blog.blog-single')->name('blog-single');
  Route::get('/add-news', 'Admins\AdminNewsController@createNews')->name('add-news');
